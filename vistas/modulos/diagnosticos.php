...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar diagnostico</li>
				...
				<div class="modal-header">
		      	...
		      	<div class="modal-body">
		      		<div class="form-group">
			        	<label>Ingresa el diagnostico</label>
...
$(document).ready(function(){
	...
	{
		$.ajax({			
			url:"vistas/modulos/diagnosticos/work/fetch.php",
	...
	$('#api_crud_form').on('submit', function(event){
		...
		else
		{
			...
			$.ajax({				
				url:"vistas/modulos/diagnosticos/work/action.php",
				method:"POST",
				data:form_data,
				success:function(data)
				{
